...
<html>
<head>
	<title>Room info | United Boys Hostel</title>
...
<center>
	<i class="material-icons" style="font-size: 70px;">house</i><span style="font-size: 60px;"><ins>Room Information</ins></span>
	<br/><br/><br/>
	<table style="width:70%;">
<caption ><b>Room Information..</b></caption>
<tr>
   <th>Room id</th>
   <th>Room category</th>
   <th>Room type</th>
  ...
  if ($res=$conn->query($sql)) {
    ...
    while ($rows=$res->fetch_assoc()) {
     ...
     ?>
          ...
          <td><?php echo $rows['Roomcat']; ?></td>
          <td><?php echo $rows['Roomtype']; ?></td>
          <td><?php echo $rows['Roomrent']; ?></td>
          <td><?php echo $rows['Bookingstatus']; ?></td>
          <td><?php echo $rows['Totalstd']; ?></td>
</tr>
